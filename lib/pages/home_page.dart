          ...
          children: [
            ...
            CustomDropdownMenuWidget(
              ...
              items: [
                ...
                Item(title: 'Unión', action: () => _goToLanguage('Unión', 4)),
                Item(title: 'Intersección', action: () => _goToLanguage('Intersección', 5)),
                Item(title: 'Resta', action: () => _goToLanguage('Resta', 6)),
                Item(title: 'Clausura de Kleene', action: () => _goToLanguage('Clausura de Kleene', 7)),
                Item(title: 'Clausura Positiva', action: () => _goToLanguage('Clausura Positiva', 8)),
              ],
            ),
          ],
        ),
